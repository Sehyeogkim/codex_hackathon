...
Demo 2는 **DexYCB subject-01** right-hand mustard-bottle sequence 3개를
대상으로 한다. RGB-derived human segment와 generated carry/place/release segment를
분리 표시한다. 학습은 이 Devbox의 GPU로 가장하지 말고 승인된
RunPod job으로 실행한다.
