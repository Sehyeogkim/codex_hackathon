"""Demo 1: one human video becomes one validated Franka episode.
    ...
    python scripts/demo1_video_to_robot.py data/demo1/take_01.mp4
"""
import argparse
import pathlib
import sys
...
from mimic.export import write_csv, write_json
from mimic.hands import clean, track_video
from mimic.retarget import anchor_to_scene, hand_to_ee
from mimic.rollout import rollout
