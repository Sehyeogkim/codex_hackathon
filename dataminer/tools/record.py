"""Record a hand demonstration from the webcam, with live tracking feedback.
    ...
    python -m dataminer.tools.record                 # 12s, saves data/demo.mp4
    python -m dataminer.tools.record --seconds 20 --out data/pour.mp4
"""
import argparse
import pathlib
import time
...
from dataminer.simulation.hands import MODEL_PATH
