    ...
    *,
    ...
    return [
        ...
        (
            ...
            ".venv/bin/python -m pip install -r dataminer/requirements.txt"
        ),
        (
...
def run_on_runloop(
    ...
    output_dir: str | Path,
    *,
    config_path: str | Path = PROJECT_ROOT / "dataminer" / "config" / "demo_config.json",
    grasp_frame: int | None = None,
    release_frame: int | None = None,
    render: bool = False,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=PROJECT_ROOT / "dataminer" / "config" / "demo_config.json",
